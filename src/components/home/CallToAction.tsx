    ...
    <section className="py-16 relative bg-gradient-to-b from-[--navy-default] to-[--navy-dark] overflow-hidden">
      ...
      <div className="absolute -right-40 top-1/2 transform -translate-y-1/2 opacity-10 w-[600px]">
        <svg width="100%" height="100%" viewBox="0 0 200 200">
          ...
          {/* Grid pattern */}
          <path 
            d="M40,40 L160,40 M40,80 L160,80 M40,120 L160,120 M40,160 L160,160 M40,40 L40,160 M80,40 L80,160 M120,40 L120,160 M160,40 L160,160" 
            stroke="#D4AF37" 
            strokeWidth="1" 
            strokeOpacity="0.3"
          />
          ...
          {/* M letter */}
          <path 
            d="M60,60 L80,140 L100,80 L120,140 L140,60" 
          ...
          {/* Swords */}
          <path 
            d="M30,30 L60,60 M170,30 L140,60" 
            stroke="url(#goldGradientLarge)" 
            strokeWidth="6" 
            strokeLinecap="round"
          />
